package br.com.projetofinal.projetointegrador.dao.impl;

import br.com.projetofinal.projetointegrador.config.ConfiguracaoJDBC;
import br.com.projetofinal.projetointegrador.dao.IDao;
...
public class DentistaDaoImpl implements IDao<Dentista> {
    ...
    public class DentistaNaoEncontrado extends Exception {
        public DentistaNaoEncontrado() {
    ...
    public void excluir(Integer id) {
        try {
            ...
            if (rows == 0) {
                throw new DentistaDaoImpl.DentistaNaoEncontrado();
            }
        } catch (SQLException | DentistaDaoImpl.DentistaNaoEncontrado e) {
            e.printStackTrace();
        }
    }
}
